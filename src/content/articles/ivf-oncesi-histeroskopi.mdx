...
references:
  - title: "Uterine cavity assessment prior to IVF"
    authors: "Pundir J, El Toukhy T"
    journal: "Women's Health"
    year: 2010
    doi: "10.2217/whe.10.61"
    pmid: "21118042"
  - title: "Should diagnostic hysteroscopy be performed before in vitro fertilization-embryo transfer?"
    authors: "Surrey ES"
    journal: "Journal of Minimally Invasive Gynecology"
    year: 2012
    doi: "10.1016/j.jmig.2012.04.003"
    pmid: "22935306"
  - title: "Office hysteroscopy in an in vitro fertilization program"
    authors: "Lorusso F, Ceci O, Bettocchi S et al."
    journal: "Gynecological Endocrinology"
    year: 2008
    doi: "10.1080/09513590802246232"
    pmid: "18850385"
...
<HizliCevap question="Tüp Bebek Öncesi Histeroskopi ve Laparoskopi Başarıyı Artırır mı?">
Tüp bebek tedavisine hazırlık sürecinde histeroskopi ve laparoskopinin rolü. Hangi durumlarda uygulanmalıdır? Başarı oranlarına etkisi.
</HizliCevap>
...
[Tarama histeroskopisi](/makaleler/endoskopik-cerrahi-histeroskopi/), infertilite nedeniyle değerlendirilen hastalarda, vajinal ultrason ve/veya histerosalpingografi (HSG) ile herhangi bir belirgin patoloji tespit edilmemesine rağmen, endometrial kavite ve endoservikal kanalın doğrudan görüntülenmesine yönelik yapılan bir girişimdir.
...
Daha da önemlisi, yalnızca **yüksek kaliteli randomize kontrollü çalışmaların (RCT)** dâhil edildiği hassasiyet analizlerinde, histeroskopi yapılan ve yapılmayan gruplar arasında **canlı doğum oranı açısından anlamlı bir fark saptanmadı** (RR 0,99). <InlineEvidence grade="A" />
...
**Klinikte Uyguladığım Yaklaşım:** İlk IVF denemesi öncesi rutin histeroskopi yapmıyorum. Ancak yukardaki risk etkenlerinden biri veya birkaçı varsa, hasta ile risk-fayda dengesini tartışıp, bireysel karar veriyoruz.
...
Birçok çalışma, [RIF](/makaleler/basarisiz-denemeler/) hastalarında histeroskopinin faydalı olabileceğini gösteriyor:
...
**Ağrıyı etkileyen başlıca etkenler:**
...
Özetle; normal zamanda yapılmış, güvenilir bir ultrason çoğu hasta için yeterlidir. Histeroskopi ise rutin bir adım değil, **risk etkenleri varlığında devreye giren tamamlayıcı bir yöntem** olarak düşünülmelidir.
...
* **Genetik, hormonal, trombofilik ya da erkek kaynaklı etkenlere ait net sorunlar** varsa,
...
Özetle; RIF’de histeroskopi çoğu zaman doğru bir hamledir, ancak **tek başına sihirli bir çözüm değildir**. En iyi sonuçlar, **embriyo kalitesi, endometrium ve genel infertilite etkenlerinin birlikte, dengeli ve kişiye özel değerlendirilmesiyle** elde edilir.
