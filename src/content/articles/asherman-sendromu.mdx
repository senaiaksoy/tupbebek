...
expertContribution:
  ...
  question: "Orta-ağır Asherman'da ilk adezyolizden sonra ikinci bakış histeroskopiyi ne zaman ve hangi bulguya göre planlıyorsunuz; bariyer veya östrojen desteğini kimde kullanıyor, kimde gereksiz buluyorsunuz?"
  text: |-
    Orta-ağır Asherman’da ikinci bakışı, transfer veya gebelik denemesinden önce rahim boşluğunun açık kaldığını görmek için planlarım. İlk ameliyatta yoğun yapışıklık, geniş karşılıklı çıplak yüzeyler veya tam açılamayan fundus ve tüp ağızları varsa yaklaşık 4–6 hafta içinde ofis histeroskopisi yaparım; yeniden oluşan ince yapışıklıklar varsa aynı aşamada ayrılabilir. Boşluk iyi açılmışsa genellikle 2–3 adet döngüsü içinde kontrol yeterlidir. Ameliyat sonrası adetin hiç gelmemesi veya belirgin azalması kontrolü öne çeker. Erken bakış yeniden yapışmanın azalmasıyla ilişkilidir; ancak canlı doğumu artırdığını kesin olarak söyleyemem.

    Geniş ve birbirine temas eden yara yüzeyleri bırakan ağır olguda balon gibi mekanik bir bariyer düşünürüm; jel bariyerin yeniden yapışmayı önlemedeki yeri daha tartışmalıdır. Östrojen desteğini endometriumun yeniden gelişmesini umduğum seçilmiş olgularda kullanabilirim; her hastaya rutin veya yüksek doz vermem. Boşluk tamamen açılmış ve endometrium iyi görünüyorsa ek tedavinin yararı belirsizdir. Balonun yapışıklık tekrarını azaltabildiğine dair veri var, fakat canlı doğuma katkısı net değil. Östrojen verilen ve verilmeyen hastaları karşılaştıran randomize çalışmalarda da östrojenin yeniden yapışmayı azalttığı ya da gebelik ve canlı doğumu belirgin biçimde artırdığı gösterilmedi.
  evidenceNote: "Guo J 2023 meta-analizinde balon ve ikinci bakış histeroskopi yeniden yapışmayı azaltırken jel anlamlı değildi. Östrojen için Yang 2022 ve Hanstede 2023 randomize çalışmalarında yeniden yapışma, gebelik ve canlı doğumda belirgin fark bulunmadı."
...
references:
  ...
  - title: "The Effect of Estrogen in the Prevention of Adhesion Reformation after Hysteroscopic Adhesiolysis: A Prospective Randomized Control Trial"
    authors: "Yang L, Ma N, Song D, Huang X, Zhou Q, Guo Y, Xia E, Shi X, Li TC"
    journal: "Journal of Minimally Invasive Gynecology"
    year: 2022
    doi: "10.1016/j.jmig.2022.04.004"
    pmid: "35439645"
    url: "https://pubmed.ncbi.nlm.nih.gov/35439645/"
  - title: "Hormonal support in women with Asherman syndrome does not lead to better outcomes: A randomized trial"
    ...
    pmid: "37396823"
    url: "https://pubmed.ncbi.nlm.nih.gov/37396823/"
---
...
1. [Merak edilen sorular](#sik-aranan)
...
<h2 id="sik-aranan">Merak Edilen Asherman ve Rahim İçi Yapışıklık Soruları</h2>
...
- Randomize çalışmalarda rutin postoperatif östrojen yeniden yapışmayı azaltmamış ([Yang 2022](https://pubmed.ncbi.nlm.nih.gov/35439645/)); gebelik ve canlı doğum oranlarında da belirgin üstünlük göstermemiştir ([Hanstede 2023](https://pubmed.ncbi.nlm.nih.gov/37396823/)). <InlineEvidence grade="B" />
