...
3. **Laparoskopi**
   - Kesin tanı için altın standart yöntemdir. <InlineEvidence grade="B" /> Küçük bir kesiyle karın içine kamera (laparoskop) yerleştirilerek kistler ve lezyonlar doğrudan görülür.
