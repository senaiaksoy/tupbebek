...
Amenore bir hastalık değil, **altta yatan endokrin veya anatomik bir bozukluğun belirtisidir**. İki ana grupta incelenir: **primer amenore** (15 yaşına kadar adet hiç görmemek; en sık nedenleri Mullerian anomalileri **%47**, Turner sendromu **%20**, hipogonadotropik hipogonadizm **%15**) ve **sekonder amenore** (önceden adetli kadında ≥3 ay adet yokluğu; en sık nedeni gebeliktir; ardından PCOS, hipotalamik amenore, hiperprolaktinemi, prematür over yetmezliği gelir). 40 yaşından önce adet kesilen kadınlarda **prematür over yetmezliği (POI)** düşünülmeli — prevalans **%3.5'tir** (ESHRE 2024). Tedavi nedene yöneliktir; ancak **östrojen eksikliği uzun vadede osteoporoz, kardiyovasküler hastalık ve infertilite riskini artırır** — bu yüzden gözlemle bırakılmaz.
</HizliCevap>
