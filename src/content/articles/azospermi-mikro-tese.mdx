---
title: "Azospermi ve Mikro-TESE: Tanıdan Babalığa Kanıt Tabanlı Yol Haritası"
seoTitle: "Azospermi ve Mikro-TESE"
description: "Azospermi (OA/NOA) ayrımı, AUA/ASRM 2024 değerlendirme protokolü, mikro-TESE sperm bulma oranları, Klinefelter ve Y kromozomu delesyonları, mikro-TESE sonrası ICSI ile kümülatif canlı doğum verileri."
...
<HizliCevap question="Azospermi varsa baba olmak hâlâ mümkün mü?">
Azospermi, menide sperm bulunmaması durumudur ve erkek infertilitesinin yaklaşık **%10-15'inde** karşılaşılır. Tedavi yaklaşımı azosperminin tipine göre değişir: tıkanıklığa bağlı (OA) tipte sperm üretimi normaldir; mikro-TESE ile **neredeyse %100'e yakın** oranda sperm bulunur. Üretim sorununa bağlı (NOA) tipte ise [Bernie 2015](https://pubmed.ncbi.nlm.nih.gov/25307747/) meta-analizine göre mikro-TESE sperm bulma oranı **%40-60** düzeyindedir ve bulunan sperm ICSI ile kullanıldığında kümülatif canlı doğum oranı **%46'ya** ([Janosek-Albright 2022](https://pubmed.ncbi.nlm.nih.gov/35813616/)) ulaşabilir. Karar verme süreci [AUA/ASRM 2024](https://pubmed.ncbi.nlm.nih.gov/39145501/) değerlendirme protokolüne göre yapılmalı, mikro-TESE öncesi mutlaka karyotip ve Y kromozomu AZF mikrodelesyonu analizi tamamlanmalıdır.
</HizliCevap>
