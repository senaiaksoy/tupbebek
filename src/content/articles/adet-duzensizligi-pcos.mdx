...
export const pcosFaqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Çoğu hastada hayır. Başka infertilite faktörü yoksa ilk adım yumurtlamayı düzenlemek olabilir. Tüp bebek, ovülasyon indüksiyonuna yanıt alınamadığında veya erkek faktörü, tüp tıkanıklığı, ileri yaş ya da düşük rezerv gibi ek nedenler olduğunda değerlendirilir. Tüp bebek planlanırsa PCOS'a özgü OHSS riski ve protokol seçimi ayrı bir değerlendirme konusudur."
      }
    },
    {
      "@type": "Question",
