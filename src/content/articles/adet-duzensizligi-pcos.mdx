...
Polikistik over sendromu (PCOS), adet düzensizliği ve seyrek yumurtlamanın en sık nedenlerinden biridir; ancak her düzensiz adet PCOS demek değildir. 2023 uluslararası PCOS rehberine göre tanı, hiperandrojenizm, ovülasyon disfonksiyonu ve polikistik over morfolojisi/uygun erişkinlerde AMH bulgularından en az ikisinin görülmesi ve benzer tablo yapan tiroid, prolaktin, adrenal veya over rezervi sorunlarının dışlanmasıyla konur. Gebelik isteyen hastalarda çoğu zaman ilk basamak hedef yumurtlamayı düzenlemektir; tüp bebek ise ek faktörler varsa veya ovülasyon indüksiyonuna yanıt alınamazsa değerlendirilir.
</HizliCevap>
...
- **PCOS + gebelik isteği varsa:** önce yumurtlama düzeni ve eşlik eden faktörler ele alınır; gerekirse [aşılama](/makaleler/iui-nedir/) veya [tüp bebek aşamaları](/tup-bebek-asamalari/) planına geçilir.
...
export const pcosFaqSchema = {
  ...
  "mainEntity": [{
    ...
    "@type": "Question",
    "name": "Adet düzensizliği her zaman PCOS anlamına mı gelir?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Hayır. Tiroid bozuklukları, hiperprolaktinemi, hipotalamik amenore, prematür over yetmezliği ve bazı adrenal hastalıklar da adet düzensizliği yapabilir. Bu nedenle tanı klinik değerlendirme ve gerekli testlerle konur."
    }
  }, {
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "AMH yüksekliği tek başına PCOS tanısı koydurur mu?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Hayır. AMH erişkinlerde polikistik over morfolojisine alternatif bir araç olarak kullanılabilir; ancak tek başına PCOS tanısı için yeterli değildir. Adet düzeni, hiperandrojenizm ve dışlama tanılarıyla birlikte yorumlanmalıdır."
    }
  }, {
    "@type": "Question",
