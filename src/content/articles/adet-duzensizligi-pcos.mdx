---
title: "Polikistik Over Sendromu (PCOS) ve Adet Düzensizliği: Tanı, Tedavi ve Uzun Vadeli Yönetim"
description: "Rotterdam 2023 güncellemeli PCOS tanısı, AMH yeni kriter olarak, letrozole birinci basamak ovülasyon indüksiyonu, IVF'de OHSS riski, uzun vadeli T2DM ve endometriyal kanser riskleri."
...
Polikistik over sendromu (PCOS), üreme çağı kadınlarda en sık görülen hormonal bozukluktur ve anovulatuar infertilitenin başlıca nedenidir. Rotterdam 2023 güncellemesine göre tanı için üç kriterden (hiperandrojenizm, ovülasyon disfonksiyonu, polikistik over morfolojisi) ikisinin bulunması yeterlidir; ultrason yerine artık alternatif olarak serum AMH ölçümü kabul edilmektedir. Gebelik isteyen hastalarda **letrozole birinci basamak** tedavidir; uzun vadede ise endometriyal kanser, tip 2 diyabet ve kardiyovasküler hastalık riski artar — bu yüzden ömür boyu metabolik takip gerekir.
</HizliCevap>
...
- **17-OH progesteron** — konjenital adrenal hiperplaziyi dışlamak için zorunlu
...
**1. Yaşam tarzı değişiklikleri — birinci basamak.** **%5-10 kilo kaybı** tek başına ovülasyonu ve siklus düzenini restore edebilir, hiperandrojenizmi azaltır ve insülin duyarlılığını iyileştirir. <InlineEvidence grade="A" /> Akdeniz tipi beslenme, düzenli aerobik egzersiz (haftada en az 150 dakika), uyku düzeni ve stres yönetimi temel taşlardır.
...
Bu grupta hedef ovülasyonun restore edilmesi ve canlı doğum oranının artırılmasıdır.
...
Bu kanıt temelinde **2023 PCOS uluslararası rehberi letrozole'u birinci basamak ovülasyon indüksiyon ilacı olarak önermektedir**. Doz: 2.5 mg/gün × 5 gün, siklusun 3-7. günleri; ovülasyon yoksa sonraki sikluslarda 5 mg/gün veya 7.5 mg/gün'e titrasyon yapılır.

**2. Clomiphene citrate (CC).** Letrozole'a erişimin olmadığı veya kontrendike olduğu durumlarda kullanılır. 50-150 mg/gün × 5 gün. Anti-estrojenik endometriyal etkisi nedeniyle implantasyon oranları letrozole'a göre daha düşük olabilir. 6 siklustan fazla kullanım önerilmez.

**3. Gonadotropinler.** Letrozole ve clomiphene'a dirençli (CC-resistant) PCOS vakalarında kullanılır. **Düşük doz step-up protokolü** tercih edilir; high-order multiple pregnancy ve OHSS riskini en aza indirir. Yakın transvajinal USG ve estradiol takibi zorunludur.

**4. IVF ve OHSS riski — PCOS'un en kritik IVF konusu**

PCOS hastaları **ovaryan hiperstimülasyon sendromu (OHSS) açısından en yüksek risk grubudur**. <InlineEvidence grade="A" /> Modern IVF pratiği OHSS'i neredeyse tamamen önleyebilen üç sütuna dayanır:
...
- **Freeze-all stratejisi** — taze transfer yapılmaz; tüm embriyolar dondurulup ileride hormonu normalleşmiş ortamda transfer edilir. Bu yaklaşımla şiddetli OHSS oranı **%1'in altına** iner.

Adjuvan tedaviler arasında **cabergoline** (0.5 mg/gün × 8 gün) ve dengeli sıvı yönetimi yer alır. 2024 vaka serileri, GnRH-a trigger + freeze-all kombinasyonunun bile yüksek-yanıtlayıcı PCOS hastalarında %100 koruma sağlamadığını göstermiştir; bu yüzden seçilmiş hastalarda **erken transfer iptal kararı** ve yakın klinik takip şarttır.
...
Büyük çoğunluk evet. PCOS anovulatuar infertilitenin en sık nedenidir ama uygun tedaviye yüksek oranda yanıt verir. Letrozole birinci basamak ovülasyon indüksiyon ilacıdır ve kümülatif canlı doğum oranı yaklaşık %27.5'tir (Legro 2014). Yanıt alınamayan veya başka faktörler eklenen olgularda IVF de yüksek başarı ile uygulanabilir — ancak OHSS riskine karşı **GnRH antagonist protokol + GnRH-a trigger + freeze-all** üçlüsü standart hâline gelmelidir.
