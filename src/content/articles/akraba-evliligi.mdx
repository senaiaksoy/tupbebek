...
seoTitle: "Akraba Evliliği Nedir? Genetik Risk"
description: "Akraba evliliği nedir? Aralarında kan bağı olan kişiler arasındaki evliliklerde otosomal resesif hastalık riski, taşıyıcılık taraması, genetik danışmanlık ve PGT-M."
...
Akraba evliliklerinde, özellikle birinci derece kuzen evliliklerinde, çiftin ortak atalardan gelen resesif hastalık mutasyonlarını paylaşma olasılığı arttığından otosomal resesif kalıtsal hastalık riski genel popülasyona kıyasla belirgin şekilde yükselir ([Hamamy 2012](https://doi.org/10.1007/s12687-011-0072-y)). Türkiye genelinde akraba evliliği prevalansı %18-24 seviyelerindedir ([Yilmaz 2016](https://pubmed.ncbi.nlm.nih.gov/26892044/)). Birinci derece kuzenlerin çocuklarında konjenital anomali riski iki kata yakın artarken ([Bromiker 2010](https://pubmed.ncbi.nlm.nih.gov/20832202/)), infant mortalitesinde de ek bir artış görülebilir ([Bittles 2010](https://pubmed.ncbi.nlm.nih.gov/19805052/)). Bu nedenle, üreme planı yapan akraba çiftlere prekonseptional genetik danışmanlık ve ACMG/ACOG standartlarında genişletilmiş taşıyıcılık taramaları önerilmektedir ([Gregg 2021](https://pubmed.ncbi.nlm.nih.gov/34285390/)). Her iki eşin de aynı genetik hastalık için taşıyıcı çıkması durumunda, tüp bebek yöntemiyle birlikte uygulanan PGT-M (tek gen taraması) sayesinde sağlıklı embriyoların seçilerek aktarılması mümkündür ([Sermon 2020](https://pubmed.ncbi.nlm.nih.gov/32752000/)).
</HizliCevap>
...
Akraba evlilikleri Akdeniz havzası, Orta Doğu, Kuzey Afrika ve Güney Asya’da yaygındır. Türkiye’de oran görece yüksektir. Expanded carrier screening, PGT-M ve haplotip analizi bu riskleri yönetmek için güçlü araçlardır.
