...
<table>
  <thead>
    <tr>
      <th>Kriter</th>
      <th>Neden Önemli?</th>
      <th>İdeal Standart</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>**Embriyolog Deneyimi**</td>
      <td>Mikroenjeksiyon (ICSI) işlemi, mikronluk hassasiyet gerektiren bir el sanatıdır.</td>
      <td>ESHRE sertifikalı, kıdemli embriyologlar.</td>
    </tr>
    <tr>
      <td>**Kalite Kontrol (QC)**</td>
      <td>Embriyolar dış ortam koşullarına çok hassastır.</td>
      <td>Düzenli hava kalitesi ve gaz ölçümleri.</td>
    </tr>
    <tr>
      <td>**Embriyo Skorlama**</td>
      <td>Doğru embriyoyu seçmek tutunma şansını artırır.</td>
      <td>Gardner kriterlerine göre detaylı sınıflandırma (5AA, 4AB vb.).</td>
    </tr>
  </tbody>
</table>
</MedicalInfoBox>
