...
export const EVIDENCE_GRADE_MAP: Record<RecommendationGrade, EvidenceGradeConfig> = {
  A: {
    grade: 'A',
    label: 'Cok Guclu',
    strength: 'Birden fazla yuksek kaliteli RKÇ veya meta-analiz',
  ...
  B: {
    grade: 'B',
    label: 'Guclu',
    strength: 'Sinirli RKÇ veya iyi tasarlanmis kohort calismalari',
    description: 'Bu yazidaki ana oneriler, sinirli sayida RKÇ veya guclu gozlemsel kohort verileri ile desteklenir.',
